...
//    InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(view -> Service_12.super.onBackPressed());


        //=======Eseba===========//
        Eseba1.setOnClickListener(view -> {
